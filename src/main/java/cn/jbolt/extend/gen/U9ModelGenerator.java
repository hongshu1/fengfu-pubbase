...
public class U9ModelGenerator extends JFinalModelGenerator {
    ...
    public static void main(String[] args) {
        ...
        new U9ModelGenerator().generate(configName, dataDictionaryVersion, dataDictionaryDescription);
    }
}
