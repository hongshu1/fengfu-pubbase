package cn.jbolt.extend.controller;
 ...
 * @author Kephon
 */
public class BaseMesAdminController extends JBoltBaseController {
    ...
    protected void copyPropertiesIncludes(Model<?> source, Model<?> target, String... includesArr) {
        if (ArrayUtil.isEmpty(includesArr)) {
            return;
        }
