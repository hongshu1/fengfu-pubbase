...
public abstract class BaseStockoutDefect<M extends BaseStockoutDefect<M>> extends JBoltBaseModel<M>{
    /**主键ID*/
	 ...
	 * 出货检ID
	 */
	public M setIStockoutQcFormMid(java.lang.Long iStockoutQcFormMid) {
		set("iStockoutQcFormMid", iStockoutQcFormMid);
		return (M)this;
	}
	 ...
	 * 出货检ID
	 */
	@JBoltField(name="istockoutqcformmid" ,columnName="iStockoutQcFormMid",type="Long", remark="出货检ID", required=true, maxLength=19, fixed=0, order=6)
