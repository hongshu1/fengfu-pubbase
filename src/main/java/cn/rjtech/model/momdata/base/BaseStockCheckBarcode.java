...
public abstract class BaseStockCheckBarcode<M extends BaseStockCheckBarcode<M>> extends JBoltBaseModel<M>{
    /**AutoID*/
	 ...
	 * 账面件数
	 */
	@JBoltField(name="num" ,columnName="Num",type="BigDecimal", remark="账面件数", required=true, maxLength=18, fixed=6, order=6)
	@JSONField(name = "num")
	 ...
	 * 实际件数
	 */
	@JBoltField(name="realnum" ,columnName="RealNum",type="BigDecimal", remark="实际件数", required=true, maxLength=18, fixed=6, order=8)
