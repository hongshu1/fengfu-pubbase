...
public abstract class BaseRcvPlanM<M extends BaseRcvPlanM<M>> extends JBoltBaseModel<M>{
    /**主键ID*/
    ...
    /**取货计划单号*/
    public static final String CRCVPLANNO = "cRcvPlanNo";
    /**客户ID*/
    public static final String ICUSTOMERID = "iCustomerId";
    /**状态：1. 已保存 2. 待审批 3. 已审批 4. 审批不通过*/
	 ...
	 * 取货计划单号
	 */
	public M setCRcvPlanNo(java.lang.String cRcvPlanNo) {
		set("cRcvPlanNo", cRcvPlanNo);
		return (M)this;
	}
	 ...
	 * 取货计划单号
	 */
	@JBoltField(name="crcvplanno" ,columnName="cRcvPlanNo",type="String", remark="取货计划单号", required=true, maxLength=40, fixed=0, order=5)
	@JSONField(name = "crcvplanno")
	public java.lang.String getCRcvPlanNo() {
		return getStr("cRcvPlanNo");
	}
	 ...
	 * 状态：1. 已保存 2. 待审批 3. 已审批 4. 审批不通过
	 */
	@JBoltField(name="istatus" ,columnName="iStatus",type="Integer", remark="状态：1. 已保存 2. 待审批 3. 已审批 4. 审批不通过", required=true, maxLength=10, fixed=0, order=7)
	 ...
	 * 审批方式：1. 审核 2. 审批流
	 */
	@JBoltField(name="iauditway" ,columnName="iAuditWay",type="Integer", remark="审批方式：1. 审核 2. 审批流", required=true, maxLength=10, fixed=0, order=8)
