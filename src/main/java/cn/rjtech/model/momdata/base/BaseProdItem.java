...
public abstract class BaseProdItem<M extends BaseProdItem<M>> extends JBoltBaseModel<M>{
    ...
    /**生产项目编码*/
    public static final String CPRODITEMCODE = "cProdItemCode";
    /**生产项目名称*/
    public static final String CPRODITEMNAME = "cProdItemName";
    /**创建人ID*/
	 ...
	 * 生产项目编码
	 */
	public M setCProdItemCode(java.lang.String cProdItemCode) {
		set("cProdItemCode", cProdItemCode);
		return (M)this;
	}
	 ...
	 * 生产项目编码
	 */
	@JBoltField(name="cproditemcode" ,columnName="cProdItemCode",type="String", remark="生产项目编码", required=true, maxLength=40, fixed=0, order=5)
	@JSONField(name = "cproditemcode")
	public java.lang.String getCProdItemCode() {
		return getStr("cProdItemCode");
	}

	/**
	 * 生产项目名称
	 */
	public M setCProdItemName(java.lang.String cProdItemName) {
		set("cProdItemName", cProdItemName);
		return (M)this;
	}
	 ...
	 * 生产项目名称
	 */
	@JBoltField(name="cproditemname" ,columnName="cProdItemName",type="String", remark="生产项目名称", required=true, maxLength=60, fixed=0, order=6)
	@JSONField(name = "cproditemname")
	public java.lang.String getCProdItemName() {
		return getStr("cProdItemName");
	}
