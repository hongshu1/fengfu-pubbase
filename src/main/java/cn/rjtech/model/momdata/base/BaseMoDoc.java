...
public abstract class BaseMoDoc<M extends BaseMoDoc<M>> extends JBoltBaseModel<M>{
    ...
    /**状态：1. 未安排人员 2. 已安排人员 3. 生成备料表 4. 待生产 5. 生产中 6. 已完工 7. 已关闭 8. 已取消*/
	 ...
	 * 制造工单任务ID
	 */
	@JBoltField(name="imotaskid" ,columnName="iMoTaskId",type="Long", remark="制造工单任务ID", required=true, maxLength=19, fixed=0, order=2)
	 ...
	 * 生产工单号
	 */
	@JBoltField(name="cmodocno" ,columnName="cMoDocNo",type="String", remark="生产工单号", required=true, maxLength=50, fixed=0, order=5)
	 ...
	 * 计划日期
	 */
	@JBoltField(name="dplandate" ,columnName="dPlanDate",type="Date", remark="计划日期", required=true, maxLength=10, fixed=0, order=6)
	 ...
	 * 年
	 */
	@JBoltField(name="iyear" ,columnName="iYear",type="Integer", remark="年", required=true, maxLength=10, fixed=0, order=7)
	 ...
	 * 月
	 */
	@JBoltField(name="imonth" ,columnName="iMonth",type="Integer", remark="月", required=true, maxLength=10, fixed=0, order=8)
	 ...
	 * 日
	 */
	@JBoltField(name="idate" ,columnName="iDate",type="Integer", remark="日", required=true, maxLength=10, fixed=0, order=9)
	 ...
	 * 生产部门（系）ID
	 */
	@JBoltField(name="idepartmentid" ,columnName="iDepartmentId",type="Long", remark="生产部门（系）ID", required=true, maxLength=19, fixed=0, order=10)
	 ...
	 * 班次ID
	 */
	@JBoltField(name="iworkshiftmid" ,columnName="iWorkShiftMid",type="Long", remark="班次ID", required=true, maxLength=19, fixed=0, order=11)
	 ...
	 * 计划数量
	 */
	@JBoltField(name="iqty" ,columnName="iQty",type="BigDecimal", remark="计划数量", required=true, maxLength=18, fixed=2, order=12)
	@JSONField(name = "iqty")
	 ...
	 * 完工数量
	 */
	@JBoltField(name="icompqty" ,columnName="iCompQty",type="BigDecimal", remark="完工数量", required=false, maxLength=18, fixed=2, order=13)
	 ...
	 * 人数
	 */
	@JBoltField(name="ipersonnum" ,columnName="iPersonNum",type="Integer", remark="人数", required=true, maxLength=10, fixed=0, order=14)
	 ...
	 * 产线组长人员ID
	 */
	@JBoltField(name="idutypersonid" ,columnName="iDutyPersonId",type="Long", remark="产线组长人员ID", required=false, maxLength=19, fixed=0, order=15)
	 ...
	 * 状态：1. 未安排人员 2. 已安排人员 3. 生成备料表 4. 待生产 5. 生产中 6. 已完工 7. 已关闭 8. 已取消
	 */
	@JBoltField(name="istatus" ,columnName="iStatus",type="Integer", remark="状态：1. 未安排人员 2. 已安排人员 3. 生成备料表 4. 待生产 5. 生产中 6. 已完工 7. 已关闭 8. 已取消", required=true, maxLength=10, fixed=0, order=16)
	 ...
	 * 工艺路线ID
	 */
	@JBoltField(name="iinventoryrouting" ,columnName="iInventoryRouting",type="Long", remark="工艺路线ID", required=true, maxLength=19, fixed=0, order=17)
	 ...
	 * 工艺路线名称
	 */
	@JBoltField(name="croutingname" ,columnName="cRoutingName",type="String", remark="工艺路线名称", required=true, maxLength=100, fixed=0, order=18)
	 ...
	 * 工艺路线版本
	 */
	@JBoltField(name="cversion" ,columnName="cVersion",type="String", remark="工艺路线版本", required=true, maxLength=10, fixed=0, order=19)
