...
public abstract class BaseMoMopatchweldm<M extends BaseMoMopatchweldm<M>> extends JBoltBaseModel<M>{
	 ...
	 * 审核状态;0. 未审核 1. 待审核 2. 审核通过 3. 审核不通过
	 */
	@JBoltField(name="iauditstatus" ,columnName="iAuditStatus",type="Integer", remark="审核状态;0. 未审核 1. 待审核 2. 审核通过 3. 审核不通过", required=true, maxLength=10, fixed=0, order=6)
	 ...
	 * 审核时间，不走审批流时有该值
	 */
	@JBoltField(name="daudittime" ,columnName="dAuditTime",type="Date", remark="审核时间，不走审批流时有该值", required=false, maxLength=23, fixed=3, order=7)
	 ...
	 * 审核人ID，不走审批流时有该值
	 */
	@JBoltField(name="iauditby" ,columnName="iAuditBy",type="Long", remark="审核人ID，不走审批流时有该值", required=false, maxLength=19, fixed=0, order=8)
	 ...
	 * 审核人名称，不走审批流时有该值
	 */
	@JBoltField(name="cauditname" ,columnName="cAuditName",type="String", remark="审核人名称，不走审批流时有该值", required=false, maxLength=40, fixed=0, order=9)
	 ...
	 * 审批方式;1. 审批状态 2. 审批流
	 */
	@JBoltField(name="iauditway" ,columnName="iAuditWay",type="Integer", remark="审批方式;1. 审批状态 2. 审批流", required=true, maxLength=10, fixed=0, order=10)
	 ...
	 * 提审时间
	 */
	@JBoltField(name="dsubmittime" ,columnName="dSubmitTime",type="Date", remark="提审时间", required=false, maxLength=23, fixed=3, order=11)
