...
public abstract class BaseWorkregionm<M extends BaseWorkregionm<M>> extends JBoltBaseModel<M> {
	 ...
	 * 所属部门(部门档案ID)
	 */
	@JBoltField(name="idepid" ,columnName="iDepId",type="Long", remark="所属部门(部门档案ID)", required=true, maxLength=19, fixed=0, order=2)
	@JSONField(serializeUsing= ToStringSerializer.class)
	 ...
	 * 工段编码
	 */
	public M setCworkcode(String cworkcode) {
	 ...
	 * 工段编码
	 */
	@JBoltField(name="cworkcode" ,columnName="cWorkCode",type="String", remark="工段编码", required=false, maxLength=255, fixed=0, order=3)
	 ...
	 * 工段名称
	 */
	public M setCworkname(String cworkname) {
	 ...
	 * 工段名称
	 */
	@JBoltField(name="cworkname" ,columnName="cWorkName",type="String", remark="工段名称", required=false, maxLength=255, fixed=0, order=4)
	 ...
	 * 工段长 (人员档案ID)
	 */
	public M setIpersonid(Long ipersonid) {
	 ...
	 * 工段长 (人员档案ID)
	 */
	@JBoltField(name="ipersonid" ,columnName="iPersonId",type="Long", remark="工段长 (人员档案ID)", required=false, maxLength=19, fixed=0, order=5)
	@JSONField(serializeUsing= ToStringSerializer.class)
