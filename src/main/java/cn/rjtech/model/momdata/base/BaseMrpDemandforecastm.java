...
public abstract class BaseMrpDemandforecastm<M extends BaseMrpDemandforecastm<M>> extends JBoltBaseModel<M>{
    /**主键ID*/
    ...
    /**预示单号*/
    public static final String CFORECASTNO = "cForecastNo";
    /**计划日期*/
	 ...
	 * 开始日期
	 */
	@JBoltField(name="dbegindate" ,columnName="dBeginDate",type="Date", remark="开始日期", required=true, maxLength=10, fixed=0, order=5)
	 ...
	 * 结束日期
	 */
	@JBoltField(name="denddate" ,columnName="dEndDate",type="Date", remark="结束日期", required=true, maxLength=10, fixed=0, order=6)
	 ...
	 * 预示单号
	 */
	public M setCForecastNo(java.lang.String cForecastNo) {
		set("cForecastNo", cForecastNo);
		return (M)this;
	}
	 ...
	 * 预示单号
	 */
	@JBoltField(name="cforecastno" ,columnName="cForecastNo",type="String", remark="预示单号", required=true, maxLength=40, fixed=0, order=7)
	@JSONField(name = "cforecastno")
	public java.lang.String getCForecastNo() {
		return getStr("cForecastNo");
	}
	 ...
	 * 计划日期
	 */
	@JBoltField(name="dplandate" ,columnName="dPlanDate",type="Date", remark="计划日期", required=true, maxLength=10, fixed=0, order=8)
	 ...
	 * 创建人名称
	 */
	@JBoltField(name="ccreatename" ,columnName="cCreateName",type="String", remark="创建人名称", required=true, maxLength=60, fixed=0, order=10)
	 ...
	 * 更新人名称
	 */
	@JBoltField(name="cupdatename" ,columnName="cUpdateName",type="String", remark="更新人名称", required=true, maxLength=60, fixed=0, order=13)
