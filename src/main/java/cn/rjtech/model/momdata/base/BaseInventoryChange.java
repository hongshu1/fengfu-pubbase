...
public abstract class BaseInventoryChange<M extends BaseInventoryChange<M>> extends JBoltBaseModel<M>{
    /**主键ID*/
	 ...
	 * 转换前存货ID
	 */
	public M setIBeforeInventoryId(java.lang.Long iBeforeInventoryId) {
		set("iBeforeInventoryId", iBeforeInventoryId);
		return (M)this;
	}
	 ...
	 * 转换前存货ID
	 */
	@JBoltField(name="ibeforeinventoryid" ,columnName="iBeforeInventoryId",type="Long", remark="转换前存货ID", required=true, maxLength=19, fixed=0, order=5)
	@JSONField(name = "ibeforeinventoryid", serializeUsing = ToStringSerializer.class)
	public java.lang.Long getIBeforeInventoryId() {
		return getLong("iBeforeInventoryId");
	}

	/**
	 * 抓换后存货ID
	 */
	public M setIAfterInventoryId(java.lang.Long iAfterInventoryId) {
		set("iAfterInventoryId", iAfterInventoryId);
		return (M)this;
	}
	 ...
	 * 抓换后存货ID
	 */
	@JBoltField(name="iafterinventoryid" ,columnName="iAfterInventoryId",type="Long", remark="抓换后存货ID", required=true, maxLength=19, fixed=0, order=6)
	@JSONField(name = "iafterinventoryid", serializeUsing = ToStringSerializer.class)
	public java.lang.Long getIAfterInventoryId() {
		return getLong("iAfterInventoryId");
	}
