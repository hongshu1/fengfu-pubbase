...
public abstract class BaseInventoryRouting<M extends BaseInventoryRouting<M>> extends JBoltBaseModel<M>{
	 ...
	 * 工艺路线名称
	 */
	@JBoltField(name="croutingname" ,columnName="cRoutingName",type="String", remark="工艺路线名称", required=true, maxLength=255, fixed=0, order=3)
	 ...
	 * 工艺版本
	 */
	@JBoltField(name="cversion" ,columnName="cVersion",type="String", remark="工艺版本", required=true, maxLength=255, fixed=0, order=4)
	 ...
	 * 工艺要求
	 */
	@JBoltField(name="crequirement" ,columnName="cRequirement",type="String", remark="工艺要求", required=false, maxLength=255, fixed=0, order=8)
