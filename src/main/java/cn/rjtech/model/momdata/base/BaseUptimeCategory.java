...
public abstract class BaseUptimeCategory<M extends BaseUptimeCategory<M>> extends JBoltBaseModel<M>{
    ...
    /**稼动时间参数类别编码*/
    public static final String CUPTIMECATEGORYCODE = "cUptimeCategoryCode";
    /**稼动时间参数类别名称*/
    public static final String CUPTIMECATEGORYNAME = "cUptimeCategoryName";
    /**创建人ID*/
	 ...
	 * 稼动时间参数类别编码
	 */
	public M setCUptimeCategoryCode(java.lang.String cUptimeCategoryCode) {
		set("cUptimeCategoryCode", cUptimeCategoryCode);
		return (M)this;
	}
	 ...
	 * 稼动时间参数类别编码
	 */
	@JBoltField(name="cuptimecategorycode" ,columnName="cUptimeCategoryCode",type="String", remark="稼动时间参数类别编码", required=true, maxLength=40, fixed=0, order=5)
	@JSONField(name = "cuptimecategorycode")
	public java.lang.String getCUptimeCategoryCode() {
		return getStr("cUptimeCategoryCode");
	}

	/**
	 * 稼动时间参数类别名称
	 */
	public M setCUptimeCategoryName(java.lang.String cUptimeCategoryName) {
		set("cUptimeCategoryName", cUptimeCategoryName);
		return (M)this;
	}
	 ...
	 * 稼动时间参数类别名称
	 */
	@JBoltField(name="cuptimecategoryname" ,columnName="cUptimeCategoryName",type="String", remark="稼动时间参数类别名称", required=true, maxLength=60, fixed=0, order=6)
	@JSONField(name = "cuptimecategoryname")
	public java.lang.String getCUptimeCategoryName() {
		return getStr("cUptimeCategoryName");
	}
	 ...
	 * 创建人名称
	 */
	@JBoltField(name="ccreatename" ,columnName="cCreateName",type="String", remark="创建人名称", required=true, maxLength=60, fixed=0, order=8)
