...
public abstract class BaseSubcontractSaleOrderM<M extends BaseSubcontractSaleOrderM<M>> extends JBoltBaseModel<M>{
	 ...
	 * 付款条件
	 */
	@JBoltField(name="cpaymentterm" ,columnName="cPaymentTerm",type="String", remark="付款条件", required=false, maxLength=200, fixed=0, order=10)
	 ...
	 * 业务员ID;人员ID
	 */
	@JBoltField(name="ibuspersonid" ,columnName="iBusPersonId",type="Long", remark="业务员ID;人员ID", required=false, maxLength=19, fixed=0, order=12)
	 ...
	 * 税率（小数）
	 */
	@JBoltField(name="itaxrate" ,columnName="iTaxRate",type="BigDecimal", remark="税率（小数）", required=false, maxLength=24, fixed=6, order=13)
	 ...
	 * 订单状态;1. 已保存 2. 待审核 3. 已审批
	 */
	@JBoltField(name="iorderstatus" ,columnName="iOrderStatus",type="Integer", remark="订单状态;1. 已保存 2. 待审核 3. 已审批", required=true, maxLength=10, fixed=0, order=48)
	 ...
	 * 审核状态;0. 未审核 1.待审核 2. 审核通过 3. 审核不通过
	 */
	@JBoltField(name="iauditstatus" ,columnName="iAuditStatus",type="Integer", remark="审核状态;0. 未审核 1.待审核 2. 审核通过 3. 审核不通过", required=true, maxLength=10, fixed=0, order=49)
	 ...
	 * 审批方式;1. 审批状态 2. 审批流
	 */
	@JBoltField(name="iauditway" ,columnName="iAuditWay",type="Integer", remark="审批方式;1. 审批状态 2. 审批流", required=false, maxLength=10, fixed=0, order=58)
	 ...
	 * 提审时间
	 */
	@JBoltField(name="dsubmittime" ,columnName="dSubmitTime",type="Date", remark="提审时间", required=false, maxLength=23, fixed=3, order=59)
	 ...
	 * 删除状态;0. 未删除 1. 已删除
	 */
	@JBoltField(name="isdeleted" ,columnName="IsDeleted",type="Boolean", remark="删除状态;0. 未删除 1. 已删除", required=true, maxLength=1, fixed=0, order=60)
	 ...
	 * 审核人ID
	 */
	@JBoltField(name="iauditby" ,columnName="iAuditBy",type="Long", remark="审核人ID", required=false, maxLength=19, fixed=0, order=63)
	 ...
	 * 审核人名称
	 */
	@JBoltField(name="cauditname" ,columnName="cAuditName",type="String", remark="审核人名称", required=false, maxLength=60, fixed=0, order=64)
