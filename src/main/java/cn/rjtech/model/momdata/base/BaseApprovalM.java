...
public abstract class BaseApprovalM<M extends BaseApprovalM<M>> extends JBoltBaseModel<M>{
    /**主键ID*/
    ...
    /**审批流名称*/
    public static final String CAPPROVALNAME = "cApprovalName";
    /**是否启用*/
	 ...
	 * 审批流名称
	 */
	public M setCApprovalName(java.lang.String cApprovalName) {
		set("cApprovalName", cApprovalName);
		return (M)this;
	}
	 ...
	 * 审批流名称
	 */
	@JBoltField(name="capprovalname" ,columnName="cApprovalName",type="String", remark="审批流名称", required=true, maxLength=50, fixed=0, order=5)
	@JSONField(name = "capprovalname")
	public java.lang.String getCApprovalName() {
		return getStr("cApprovalName");
	}
	 ...
	 * 是否启用
	 */
	@JBoltField(name="isenabled" ,columnName="isEnabled",type="Boolean", remark="是否启用", required=true, maxLength=1, fixed=0, order=6)
	 ...
	 * 是否自动去重：0. 否 1. 是
	 */
	@JBoltField(name="isskippedonduplicate" ,columnName="isSkippedOnDuplicate",type="Boolean", remark="是否自动去重：0. 否 1. 是", required=true, maxLength=1, fixed=0, order=7)
	 ...
	 * 是否自动通过：0. 否 1. 是
	 */
	@JBoltField(name="isapprovedonsame" ,columnName="isApprovedOnSame",type="Boolean", remark="是否自动通过：0. 否 1. 是", required=true, maxLength=1, fixed=0, order=8)
