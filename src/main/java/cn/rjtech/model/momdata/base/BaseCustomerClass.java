...
public abstract class BaseCustomerClass<M extends BaseCustomerClass<M>> extends JBoltBaseModel<M>{
    /**主键ID*/
    ...
    /**类别名称*/
    public static final String CCCNAME = "cCCName";
    /**上级ID*/
	 ...
	 * 客户分类编码
	 */
	@JBoltField(name="ccccode" ,columnName="cCCCode",type="String", remark="客户分类编码", required=true, maxLength=12, fixed=0, order=5)
	 ...
	 * 类别名称
	 */
	public M setCCCName(java.lang.String cCCName) {
		set("cCCName", cCCName);
		return (M)this;
	}
	 ...
	 * 类别名称
	 */
	@JBoltField(name="cccname" ,columnName="cCCName",type="String", remark="类别名称", required=true, maxLength=20, fixed=0, order=6)
	@JSONField(name = "cccname")
	public java.lang.String getCCCName() {
		return getStr("cCCName");
	}
	 ...
	 * 上级ID
	 */
	@JBoltField(name="ipid" ,columnName="iPid",type="Long", remark="上级ID", required=false, maxLength=19, fixed=0, order=7)
	 ...
	 * 来源ID，U8的主键为编码
	 */
	@JBoltField(name="isourceid" ,columnName="iSourceId",type="String", remark="来源ID，U8的主键为编码", required=false, maxLength=32, fixed=0, order=9)
