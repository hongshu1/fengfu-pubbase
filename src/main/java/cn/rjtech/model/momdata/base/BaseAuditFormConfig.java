...
public abstract class BaseAuditFormConfig<M extends BaseAuditFormConfig<M>> extends JBoltBaseModel<M>{
    /**主键ID*/
	 ...
	 * 表单编码
	 */
	@JBoltField(name="cformsn" ,columnName="cFormSn",type="String", remark="表单编码", required=true, maxLength=40, fixed=0, order=5)
	 ...
	 * 表单类型（名称）
	 */
	@JBoltField(name="cformname" ,columnName="cFormName",type="String", remark="表单类型（名称）", required=true, maxLength=50, fixed=0, order=6)
	 ...
	 * 审批类型：1. 审批流 2. 审批
	 */
	@JBoltField(name="itype" ,columnName="iType",type="Integer", remark="审批类型：1. 审批流 2. 审批", required=true, maxLength=10, fixed=0, order=8)
	 ...
	 * 表单ID
	 */
	@JBoltField(name="iformid" ,columnName="iFormId",type="Long", remark="表单ID", required=true, maxLength=19, fixed=0
			, order=1)
