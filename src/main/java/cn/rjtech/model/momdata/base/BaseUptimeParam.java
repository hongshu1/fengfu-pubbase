...
public abstract class BaseUptimeParam<M extends BaseUptimeParam<M>> extends JBoltBaseModel<M>{
    ...
    /**参数名称*/
    public static final String CUPTIMEPARAMNAME = "cUptimeParamName";
    /**是否启用;0. 否 1. 是*/
	 ...
	 * 稼动时间参数类别ID
	 */
	@JBoltField(name="iuptimecategoryid" ,columnName="iUptimeCategoryId",type="Long", remark="稼动时间参数类别ID", required=true, maxLength=19, fixed=0, order=5)
	 ...
	 * 参数名称
	 */
	public M setCUptimeParamName(java.lang.String cUptimeParamName) {
		set("cUptimeParamName", cUptimeParamName);
		return (M)this;
	}
	 ...
	 * 参数名称
	 */
	@JBoltField(name="cuptimeparamname" ,columnName="cUptimeParamName",type="String", remark="参数名称", required=true, maxLength=40, fixed=0, order=6)
	@JSONField(name = "cuptimeparamname")
	public java.lang.String getCUptimeParamName() {
		return getStr("cUptimeParamName");
	}
