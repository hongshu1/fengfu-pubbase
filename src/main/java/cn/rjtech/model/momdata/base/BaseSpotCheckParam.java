...
public abstract class BaseSpotCheckParam<M extends BaseSpotCheckParam<M>> extends JBoltBaseModel<M>{
    /**主键ID*/
	 ...
	 * 检验项目ID
	 */
	@JBoltField(name="iqcitemid" ,columnName="iQcItemId",type="Long", remark="检验项目ID", required=true, maxLength=19, fixed=0, order=5)
	 ...
	 * 检验参数名称
	 */
	public M setCQcParamName(java.lang.String cQcParamName) {
		set("cQcParamName", cQcParamName);
		return (M)this;
	}
	 ...
	 * 检验参数名称
	 */
	@JBoltField(name="cqcparamname" ,columnName="cQcParamName",type="String", remark="检验参数名称", required=true, maxLength=50, fixed=0, order=6)
	@JSONField(name = "cqcparamname")
	public java.lang.String getCQcParamName() {
		return getStr("cQcParamName");
	}
