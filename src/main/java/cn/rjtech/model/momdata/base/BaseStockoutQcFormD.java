...
public abstract class BaseStockoutQcFormD<M extends BaseStockoutQcFormD<M>> extends JBoltBaseModel<M>{
    /**主键ID*/
	 ...
	 * 来料检ID
	 */
	@JBoltField(name="istockoutqcformmid" ,columnName="iStockoutQcFormMid",type="Long", remark="来料检ID", required=true, maxLength=19, fixed=0, order=2)
