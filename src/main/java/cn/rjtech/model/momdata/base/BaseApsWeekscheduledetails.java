...
public abstract class BaseApsWeekscheduledetails<M extends BaseApsWeekscheduledetails<M>> extends JBoltBaseModel<M>{
    /**主键ID*/
    ...
    /**月周生产计划ID*/
    public static final String IWEEKSCHEDULEID = "iWeekScheduleId";
    /**排产层级*/
	 ...
	 * 月周生产计划ID
	 */
	public M setIWeekScheduleId(java.lang.Long iWeekScheduleId) {
		set("iWeekScheduleId", iWeekScheduleId);
		return (M)this;
	}
	 ...
	 * 月周生产计划ID
	 */
	@JBoltField(name="iweekscheduleid" ,columnName="iWeekScheduleId",type="Long", remark="月周生产计划ID", required=true, maxLength=19, fixed=0, order=5)
	@JSONField(name = "iweekscheduleid", serializeUsing = ToStringSerializer.class)
	public java.lang.Long getIWeekScheduleId() {
		return getLong("iWeekScheduleId");
	}
	 ...
	 * 排产层级
	 */
	@JBoltField(name="ilevel" ,columnName="iLevel",type="Integer", remark="排产层级", required=true, maxLength=10, fixed=0, order=6)
