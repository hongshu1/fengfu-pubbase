...
public abstract class BaseAnnualorderdAmount<M extends BaseAnnualorderdAmount<M>> extends JBoltBaseModel<M>{
    /**主键ID*/
	 ...
	 * 金额
	 */
	@JBoltField(name="iamount" ,columnName="iAmount",type="BigDecimal", remark="金额", required=true, maxLength=18, fixed=2, order=5)
