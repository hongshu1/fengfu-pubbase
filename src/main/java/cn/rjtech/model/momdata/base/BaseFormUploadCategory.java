...
public abstract class BaseFormUploadCategory<M extends BaseFormUploadCategory<M>> extends JBoltBaseModel<M>{
	 ...
	 * 分类编码
	 */
	@JBoltField(name="ccategorycode" ,columnName="cCategoryCode",type="String", remark="分类编码", required=true, maxLength=40, fixed=0, order=6)
	@JSONField(name = "ccategorycode")
	 ...
	 * 分类名称
	 */
	@JBoltField(name="ccategoryname" ,columnName="cCategoryName",type="String", remark="分类名称", required=true, maxLength=60, fixed=0, order=7)
	@JSONField(name = "ccategoryname")
	 ...
	 * 上级分类ID
	 */
	@JBoltField(name="ipid" ,columnName="iPid",type="Long", remark="上级分类ID", required=false, maxLength=19, fixed=0, order=8)
	 ...
	 * 是否启用：0. 否 1. 是
	 */
	@JBoltField(name="isenabled" ,columnName="isEnabled",type="Boolean", remark="是否启用：0. 否 1. 是", required=true, maxLength=1, fixed=0, order=16)
	 ...
	 * 备注
	 */
	@JBoltField(name="cmemo" ,columnName="cMemo",type="String", remark="备注", required=false, maxLength=200, fixed=0, order=17)
