...
public abstract class BaseQcParam<M extends BaseQcParam<M>> extends JBoltBaseModel<M>{
    /**主键ID*/
	 ...
	 * 参数名称
	 */
	@JBoltField(name="cqcparamname" ,columnName="cQcParamName",type="String", remark="参数名称", required=true, maxLength=50, fixed=0, order=5)
