...
public abstract class BaseMonthOrderM<M extends BaseMonthOrderM<M>> extends JBoltBaseModel<M>{
	 ...
	 * 订单编号
	 */
	@JBoltField(name="corderno" ,columnName="cOrderNo",type="String", remark="订单编号", required=true, maxLength=40, fixed=0, order=5)
	 ...
	 * 订单状态：1. 已保存 2. 待审批 3. 已审批
	 */
	@JBoltField(name="iorderstatus" ,columnName="iOrderStatus",type="Integer", remark="订单状态：1. 已保存 2. 待审批 3. 已审批", required=true, maxLength=10, fixed=0, order=9)
	 ...
	 * 审核时间，不走审批流时有该值
	 */
	@JBoltField(name="daudittime" ,columnName="dAuditTime",type="Date", remark="审核时间，不走审批流时有该值", required=false, maxLength=23, fixed=3, order=11)
	 ...
	 * 审核人ID，不走审批流时有该值
	 */
	@JBoltField(name="iauditby" ,columnName="iAuditBy",type="Long", remark="审核人ID，不走审批流时有该值", required=false, maxLength=19, fixed=0, order=12)
	 ...
	 * 审核人名称，不走审批流时有该值
	 */
	@JBoltField(name="cauditname" ,columnName="cAuditName",type="Date", remark="审核人名称，不走审批流时有该值", required=false, maxLength=23, fixed=3, order=13)
	 ...
	 * 创建人名称
	 */
	@JBoltField(name="ccreatename" ,columnName="cCreateName",type="String", remark="创建人名称", required=true, maxLength=60, fixed=0, order=15)
	 ...
	 * 更新人名称
	 */
	@JBoltField(name="cupdatename" ,columnName="cUpdateName",type="String", remark="更新人名称", required=true, maxLength=60, fixed=0, order=18)
	 ...
	 * 扩展字段1
	 */
	@JBoltField(name="cdefine1" ,columnName="cDefine1",type="String", remark="扩展字段1", required=false, maxLength=200, fixed=0, order=22)
	 ...
	 * 扩展字段2
	 */
	@JBoltField(name="cdefine2" ,columnName="cDefine2",type="String", remark="扩展字段2", required=false, maxLength=200, fixed=0, order=23)
	 ...
	 * 扩展字段3
	 */
	@JBoltField(name="cdefine3" ,columnName="cDefine3",type="String", remark="扩展字段3", required=false, maxLength=200, fixed=0, order=24)
	 ...
	 * 扩展字段4
	 */
	@JBoltField(name="cdefine4" ,columnName="cDefine4",type="String", remark="扩展字段4", required=false, maxLength=200, fixed=0, order=25)
	 ...
	 * 扩展字段5
	 */
	@JBoltField(name="cdefine5" ,columnName="cDefine5",type="String", remark="扩展字段5", required=false, maxLength=200, fixed=0, order=26)
	 ...
	 * 扩展字段6
	 */
	@JBoltField(name="cdefine6" ,columnName="cDefine6",type="String", remark="扩展字段6", required=false, maxLength=200, fixed=0, order=27)
	 ...
	 * 扩展字段7
	 */
	@JBoltField(name="cdefine7" ,columnName="cDefine7",type="String", remark="扩展字段7", required=false, maxLength=200, fixed=0, order=28)
	 ...
	 * 扩展字段8
	 */
	@JBoltField(name="cdefine8" ,columnName="cDefine8",type="String", remark="扩展字段8", required=false, maxLength=200, fixed=0, order=29)
	 ...
	 * 扩展字段9
	 */
	@JBoltField(name="cdefine9" ,columnName="cDefine9",type="String", remark="扩展字段9", required=false, maxLength=200, fixed=0, order=30)
	 ...
	 * 扩展字段10
	 */
	@JBoltField(name="cdefine10" ,columnName="cDefine10",type="String", remark="扩展字段10", required=false, maxLength=200, fixed=0, order=31)
	 ...
	 * 扩展字段11
	 */
	@JBoltField(name="cdefine11" ,columnName="cDefine11",type="String", remark="扩展字段11", required=false, maxLength=500, fixed=0, order=32)
	 ...
	 * 扩展字段12
	 */
	@JBoltField(name="cdefine12" ,columnName="cDefine12",type="String", remark="扩展字段12", required=false, maxLength=500, fixed=0, order=33)
	 ...
	 * 扩展字段13
	 */
	@JBoltField(name="cdefine13" ,columnName="cDefine13",type="String", remark="扩展字段13", required=false, maxLength=500, fixed=0, order=34)
	 ...
	 * 扩展字段14
	 */
	@JBoltField(name="cdefine14" ,columnName="cDefine14",type="String", remark="扩展字段14", required=false, maxLength=500, fixed=0, order=35)
	 ...
	 * 扩展字段15
	 */
	@JBoltField(name="cdefine15" ,columnName="cDefine15",type="String", remark="扩展字段15", required=false, maxLength=500, fixed=0, order=36)
	 ...
	 * 扩展字段16
	 */
	@JBoltField(name="idefine16" ,columnName="iDefine16",type="BigDecimal", remark="扩展字段16", required=false, maxLength=24, fixed=6, order=37)
	 ...
	 * 扩展字段17
	 */
	@JBoltField(name="idefine17" ,columnName="iDefine17",type="BigDecimal", remark="扩展字段17", required=false, maxLength=24, fixed=6, order=38)
	 ...
	 * 扩展字段18
	 */
	@JBoltField(name="idefine18" ,columnName="iDefine18",type="BigDecimal", remark="扩展字段18", required=false, maxLength=24, fixed=6, order=39)
	 ...
	 * 扩展字段19
	 */
	@JBoltField(name="idefine19" ,columnName="iDefine19",type="BigDecimal", remark="扩展字段19", required=false, maxLength=24, fixed=6, order=40)
	 ...
	 * 扩展字段20
	 */
	@JBoltField(name="idefine20" ,columnName="iDefine20",type="BigDecimal", remark="扩展字段20", required=false, maxLength=24, fixed=6, order=41)
	 ...
	 * 扩展字段21
	 */
	@JBoltField(name="idefine21" ,columnName="iDefine21",type="Integer", remark="扩展字段21", required=false, maxLength=10, fixed=0, order=42)
	 ...
	 * 扩展字段22
	 */
	@JBoltField(name="idefine22" ,columnName="iDefine22",type="Integer", remark="扩展字段22", required=false, maxLength=10, fixed=0, order=43)
	 ...
	 * 扩展字段23
	 */
	@JBoltField(name="idefine23" ,columnName="iDefine23",type="Integer", remark="扩展字段23", required=false, maxLength=10, fixed=0, order=44)
	 ...
	 * 扩展字段24
	 */
	@JBoltField(name="idefine24" ,columnName="iDefine24",type="Integer", remark="扩展字段24", required=false, maxLength=10, fixed=0, order=45)
	 ...
	 * 扩展字段25
	 */
	@JBoltField(name="idefine25" ,columnName="iDefine25",type="Integer", remark="扩展字段25", required=false, maxLength=10, fixed=0, order=46)
	 ...
	 * 扩展字段26
	 */
	@JBoltField(name="ddefine26" ,columnName="dDefine26",type="Date", remark="扩展字段26", required=false, maxLength=23, fixed=3, order=47)
	 ...
	 * 扩展字段27
	 */
	@JBoltField(name="ddefine27" ,columnName="dDefine27",type="Date", remark="扩展字段27", required=false, maxLength=23, fixed=3, order=48)
	 ...
	 * 扩展字段28
	 */
	@JBoltField(name="ddefine28" ,columnName="dDefine28",type="Date", remark="扩展字段28", required=false, maxLength=23, fixed=3, order=49)
	 ...
	 * 扩展字段29
	 */
	@JBoltField(name="ddefine29" ,columnName="dDefine29",type="Date", remark="扩展字段29", required=false, maxLength=23, fixed=3, order=50)
	 ...
	 * 扩展字段30
	 */
	@JBoltField(name="ddefine30" ,columnName="dDefine30",type="Date", remark="扩展字段30", required=false, maxLength=23, fixed=3, order=51)
