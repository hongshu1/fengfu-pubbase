...
public abstract class BaseMonthOrderD<M extends BaseMonthOrderD<M>> extends JBoltBaseModel<M>{
    ...
    /**下月数量*/
    public static final String IMONTH1QTY = "iMonth1Qty";
    /**下下月数量*/
    public static final String IMONTH2QTY = "iMonth2Qty";
    /**扩展字段1*/
	 ...
	 * 存货名称
	 */
	@JBoltField(name="cinvname" ,columnName="cInvName",type="String", remark="存货名称", required=false, maxLength=200, fixed=0, order=5)
	 ...
	 * 客户部番
	 */
	@JBoltField(name="cinvcode1" ,columnName="cInvCode1",type="String", remark="客户部番", required=false, maxLength=200, fixed=0, order=6)
	 ...
	 * 部品名称
	 */
	@JBoltField(name="cinvname1" ,columnName="cInvName1",type="String", remark="部品名称", required=false, maxLength=200, fixed=0, order=7)
	 ...
	 * 规格
	 */
	@JBoltField(name="cinvstd" ,columnName="cInvStd",type="String", remark="规格", required=false, maxLength=255, fixed=0, order=8)
	 ...
	 * 1日数量
	 */
	@JBoltField(name="iqty1" ,columnName="iQty1",type="BigDecimal", remark="1日数量", required=false, maxLength=24, fixed=6, order=9)
	 ...
	 * 2日数量
	 */
	@JBoltField(name="iqty2" ,columnName="iQty2",type="BigDecimal", remark="2日数量", required=false, maxLength=24, fixed=6, order=10)
	 ...
	 * 3日数量
	 */
	@JBoltField(name="iqty3" ,columnName="iQty3",type="BigDecimal", remark="3日数量", required=false, maxLength=24, fixed=6, order=11)
	 ...
	 * 4日数量
	 */
	@JBoltField(name="iqty4" ,columnName="iQty4",type="BigDecimal", remark="4日数量", required=false, maxLength=24, fixed=6, order=12)
	 ...
	 * 5日数量
	 */
	@JBoltField(name="iqty5" ,columnName="iQty5",type="BigDecimal", remark="5日数量", required=false, maxLength=24, fixed=6, order=13)
	 ...
	 * 6日数量
	 */
	@JBoltField(name="iqty6" ,columnName="iQty6",type="BigDecimal", remark="6日数量", required=false, maxLength=24, fixed=6, order=14)
	 ...
	 * 7日数量
	 */
	@JBoltField(name="iqty7" ,columnName="iQty7",type="BigDecimal", remark="7日数量", required=false, maxLength=24, fixed=6, order=15)
	 ...
	 * 8日数量
	 */
	@JBoltField(name="iqty8" ,columnName="iQty8",type="BigDecimal", remark="8日数量", required=false, maxLength=24, fixed=6, order=16)
	 ...
	 * 9日数量
	 */
	@JBoltField(name="iqty9" ,columnName="iQty9",type="BigDecimal", remark="9日数量", required=false, maxLength=24, fixed=6, order=17)
	 ...
	 * 10日数量
	 */
	@JBoltField(name="iqty10" ,columnName="iQty10",type="BigDecimal", remark="10日数量", required=false, maxLength=24, fixed=6, order=18)
	 ...
	 * 11日数量
	 */
	@JBoltField(name="iqty11" ,columnName="iQty11",type="BigDecimal", remark="11日数量", required=false, maxLength=24, fixed=6, order=19)
	 ...
	 * 12日数量
	 */
	@JBoltField(name="iqty12" ,columnName="iQty12",type="BigDecimal", remark="12日数量", required=false, maxLength=24, fixed=6, order=20)
	 ...
	 * 13日数量
	 */
	@JBoltField(name="iqty13" ,columnName="iQty13",type="BigDecimal", remark="13日数量", required=false, maxLength=24, fixed=6, order=21)
	 ...
	 * 14日数量
	 */
	@JBoltField(name="iqty14" ,columnName="iQty14",type="BigDecimal", remark="14日数量", required=false, maxLength=24, fixed=6, order=22)
	 ...
	 * 15日数量
	 */
	@JBoltField(name="iqty15" ,columnName="iQty15",type="BigDecimal", remark="15日数量", required=false, maxLength=24, fixed=6, order=23)
	 ...
	 * 16日数量
	 */
	@JBoltField(name="iqty16" ,columnName="iQty16",type="BigDecimal", remark="16日数量", required=false, maxLength=24, fixed=6, order=24)
	 ...
	 * 17日数量
	 */
	@JBoltField(name="iqty17" ,columnName="iQty17",type="BigDecimal", remark="17日数量", required=false, maxLength=24, fixed=6, order=25)
	 ...
	 * 18日数量
	 */
	@JBoltField(name="iqty18" ,columnName="iQty18",type="BigDecimal", remark="18日数量", required=false, maxLength=24, fixed=6, order=26)
	 ...
	 * 19日数量
	 */
	@JBoltField(name="iqty19" ,columnName="iQty19",type="BigDecimal", remark="19日数量", required=false, maxLength=24, fixed=6, order=27)
	 ...
	 * 20日数量
	 */
	@JBoltField(name="iqty20" ,columnName="iQty20",type="BigDecimal", remark="20日数量", required=false, maxLength=24, fixed=6, order=28)
	 ...
	 * 21日数量
	 */
	@JBoltField(name="iqty21" ,columnName="iQty21",type="BigDecimal", remark="21日数量", required=false, maxLength=24, fixed=6, order=29)
	 ...
	 * 22日数量
	 */
	@JBoltField(name="iqty22" ,columnName="iQty22",type="BigDecimal", remark="22日数量", required=false, maxLength=24, fixed=6, order=30)
	 ...
	 * 23日数量
	 */
	@JBoltField(name="iqty23" ,columnName="iQty23",type="BigDecimal", remark="23日数量", required=false, maxLength=24, fixed=6, order=31)
	 ...
	 * 24日数量
	 */
	@JBoltField(name="iqty24" ,columnName="iQty24",type="BigDecimal", remark="24日数量", required=false, maxLength=24, fixed=6, order=32)
	 ...
	 * 25日数量
	 */
	@JBoltField(name="iqty25" ,columnName="iQty25",type="BigDecimal", remark="25日数量", required=false, maxLength=24, fixed=6, order=33)
	 ...
	 * 26日数量
	 */
	@JBoltField(name="iqty26" ,columnName="iQty26",type="BigDecimal", remark="26日数量", required=false, maxLength=24, fixed=6, order=34)
	 ...
	 * 27日数量
	 */
	@JBoltField(name="iqty27" ,columnName="iQty27",type="BigDecimal", remark="27日数量", required=false, maxLength=24, fixed=6, order=35)
	 ...
	 * 28日数量
	 */
	@JBoltField(name="iqty28" ,columnName="iQty28",type="BigDecimal", remark="28日数量", required=false, maxLength=24, fixed=6, order=36)
	 ...
	 * 29日数量
	 */
	@JBoltField(name="iqty29" ,columnName="iQty29",type="BigDecimal", remark="29日数量", required=false, maxLength=24, fixed=6, order=37)
	 ...
	 * 30日数量
	 */
	@JBoltField(name="iqty30" ,columnName="iQty30",type="BigDecimal", remark="30日数量", required=false, maxLength=24, fixed=6, order=38)
	 ...
	 * 31日数量
	 */
	@JBoltField(name="iqty31" ,columnName="iQty31",type="BigDecimal", remark="31日数量", required=false, maxLength=24, fixed=6, order=39)
	 ...
	 * 合计数量
	 */
	@JBoltField(name="isum" ,columnName="iSum",type="BigDecimal", remark="合计数量", required=false, maxLength=24, fixed=6, order=40)
	@JSONField(name = "isum")
	 ...
	 * 下月数量
	 */
	public M setIMonth1Qty(java.math.BigDecimal iMonth1Qty) {
		set("iMonth1Qty", iMonth1Qty);
		return (M)this;
	}
	 ...
	 * 下月数量
	 */
	@JBoltField(name="imonth1qty" ,columnName="iMonth1Qty",type="BigDecimal", remark="下月数量", required=false, maxLength=24, fixed=6, order=41)
	@JSONField(name = "imonth1qty")
	public java.math.BigDecimal getIMonth1Qty() {
		return getBigDecimal("iMonth1Qty");
	}

	/**
	 * 下下月数量
	 */
	public M setIMonth2Qty(java.math.BigDecimal iMonth2Qty) {
		set("iMonth2Qty", iMonth2Qty);
		return (M)this;
	}
	 ...
	 * 下下月数量
	 */
	@JBoltField(name="imonth2qty" ,columnName="iMonth2Qty",type="BigDecimal", remark="下下月数量", required=false, maxLength=24, fixed=6, order=42)
	@JSONField(name = "imonth2qty")
	public java.math.BigDecimal getIMonth2Qty() {
		return getBigDecimal("iMonth2Qty");
	}
	 ...
	 * 扩展字段1
	 */
	@JBoltField(name="cdefine1" ,columnName="cDefine1",type="String", remark="扩展字段1", required=false, maxLength=200, fixed=0, order=43)
	 ...
	 * 扩展字段2
	 */
	@JBoltField(name="cdefine2" ,columnName="cDefine2",type="String", remark="扩展字段2", required=false, maxLength=200, fixed=0, order=44)
	 ...
	 * 扩展字段3
	 */
	@JBoltField(name="cdefine3" ,columnName="cDefine3",type="String", remark="扩展字段3", required=false, maxLength=200, fixed=0, order=45)
	 ...
	 * 扩展字段4
	 */
	@JBoltField(name="cdefine4" ,columnName="cDefine4",type="String", remark="扩展字段4", required=false, maxLength=200, fixed=0, order=46)
	 ...
	 * 扩展字段5
	 */
	@JBoltField(name="cdefine5" ,columnName="cDefine5",type="String", remark="扩展字段5", required=false, maxLength=200, fixed=0, order=47)
	 ...
	 * 扩展字段6
	 */
	@JBoltField(name="cdefine6" ,columnName="cDefine6",type="String", remark="扩展字段6", required=false, maxLength=200, fixed=0, order=48)
	 ...
	 * 扩展字段7
	 */
	@JBoltField(name="cdefine7" ,columnName="cDefine7",type="String", remark="扩展字段7", required=false, maxLength=200, fixed=0, order=49)
	 ...
	 * 扩展字段8
	 */
	@JBoltField(name="cdefine8" ,columnName="cDefine8",type="String", remark="扩展字段8", required=false, maxLength=200, fixed=0, order=50)
	 ...
	 * 扩展字段9
	 */
	@JBoltField(name="cdefine9" ,columnName="cDefine9",type="String", remark="扩展字段9", required=false, maxLength=200, fixed=0, order=51)
	 ...
	 * 扩展字段10
	 */
	@JBoltField(name="cdefine10" ,columnName="cDefine10",type="String", remark="扩展字段10", required=false, maxLength=200, fixed=0, order=52)
	 ...
	 * 扩展字段11
	 */
	@JBoltField(name="cdefine11" ,columnName="cDefine11",type="String", remark="扩展字段11", required=false, maxLength=500, fixed=0, order=53)
	 ...
	 * 扩展字段12
	 */
	@JBoltField(name="cdefine12" ,columnName="cDefine12",type="String", remark="扩展字段12", required=false, maxLength=500, fixed=0, order=54)
	 ...
	 * 扩展字段13
	 */
	@JBoltField(name="cdefine13" ,columnName="cDefine13",type="String", remark="扩展字段13", required=false, maxLength=500, fixed=0, order=55)
	 ...
	 * 扩展字段14
	 */
	@JBoltField(name="cdefine14" ,columnName="cDefine14",type="String", remark="扩展字段14", required=false, maxLength=500, fixed=0, order=56)
	 ...
	 * 扩展字段15
	 */
	@JBoltField(name="cdefine15" ,columnName="cDefine15",type="String", remark="扩展字段15", required=false, maxLength=500, fixed=0, order=57)
	 ...
	 * 扩展字段16
	 */
	@JBoltField(name="idefine16" ,columnName="iDefine16",type="BigDecimal", remark="扩展字段16", required=false, maxLength=24, fixed=6, order=58)
	 ...
	 * 扩展字段17
	 */
	@JBoltField(name="idefine17" ,columnName="iDefine17",type="BigDecimal", remark="扩展字段17", required=false, maxLength=24, fixed=6, order=59)
	 ...
	 * 扩展字段18
	 */
	@JBoltField(name="idefine18" ,columnName="iDefine18",type="BigDecimal", remark="扩展字段18", required=false, maxLength=24, fixed=6, order=60)
	 ...
	 * 扩展字段19
	 */
	@JBoltField(name="idefine19" ,columnName="iDefine19",type="BigDecimal", remark="扩展字段19", required=false, maxLength=24, fixed=6, order=61)
	 ...
	 * 扩展字段20
	 */
	@JBoltField(name="idefine20" ,columnName="iDefine20",type="BigDecimal", remark="扩展字段20", required=false, maxLength=24, fixed=6, order=62)
	 ...
	 * 扩展字段21
	 */
	@JBoltField(name="idefine21" ,columnName="iDefine21",type="Integer", remark="扩展字段21", required=false, maxLength=10, fixed=0, order=63)
	 ...
	 * 扩展字段22
	 */
	@JBoltField(name="idefine22" ,columnName="iDefine22",type="Integer", remark="扩展字段22", required=false, maxLength=10, fixed=0, order=64)
	 ...
	 * 扩展字段23
	 */
	@JBoltField(name="idefine23" ,columnName="iDefine23",type="Integer", remark="扩展字段23", required=false, maxLength=10, fixed=0, order=65)
	 ...
	 * 扩展字段24
	 */
	@JBoltField(name="idefine24" ,columnName="iDefine24",type="Integer", remark="扩展字段24", required=false, maxLength=10, fixed=0, order=66)
	 ...
	 * 扩展字段25
	 */
	@JBoltField(name="idefine25" ,columnName="iDefine25",type="Integer", remark="扩展字段25", required=false, maxLength=10, fixed=0, order=67)
	 ...
	 * 扩展字段26
	 */
	@JBoltField(name="ddefine26" ,columnName="dDefine26",type="Date", remark="扩展字段26", required=false, maxLength=23, fixed=3, order=68)
	 ...
	 * 扩展字段27
	 */
	@JBoltField(name="ddefine27" ,columnName="dDefine27",type="Date", remark="扩展字段27", required=false, maxLength=23, fixed=3, order=69)
	 ...
	 * 扩展字段28
	 */
	@JBoltField(name="ddefine28" ,columnName="dDefine28",type="Date", remark="扩展字段28", required=false, maxLength=23, fixed=3, order=70)
	 ...
	 * 扩展字段29
	 */
	@JBoltField(name="ddefine29" ,columnName="dDefine29",type="Date", remark="扩展字段29", required=false, maxLength=23, fixed=3, order=71)
	 ...
	 * 扩展字段30
	 */
	@JBoltField(name="ddefine30" ,columnName="dDefine30",type="Date", remark="扩展字段30", required=false, maxLength=23, fixed=3, order=72)
	 ...
	 * 删除状态;0. 未删除 1. 已删除
	 */
	@JBoltField(name="isdeleted" ,columnName="IsDeleted",type="Boolean", remark="删除状态;0. 未删除 1. 已删除", required=true, maxLength=1, fixed=0, order=73)
