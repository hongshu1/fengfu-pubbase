...
public abstract class BaseInStockQcFormM<M extends BaseInStockQcFormM<M>> extends JBoltBaseModel<M>{
    /**主键ID*/
    ...
    /**检验单号*/
    public static final String CINVQCFORMNO = "cInvQcFormNo";
    /**质检表格ID*/
	 ...
	 * 检验单号
	 */
	public M setCInvQcFormNo(java.lang.String cInvQcFormNo) {
		set("cInvQcFormNo", cInvQcFormNo);
		return (M)this;
	}
	 ...
	 * 检验单号
	 */
	@JBoltField(name="cinvqcformno" ,columnName="cInvQcFormNo",type="String", remark="检验单号", required=true, maxLength=50, fixed=0, order=5)
	@JSONField(name = "cinvqcformno")
	public java.lang.String getCInvQcFormNo() {
		return getStr("cInvQcFormNo");
	}
	 ...
	 * 现品票（条码）
	 */
	@JBoltField(name="cbarcode" ,columnName="cBarcode",type="String", remark="现品票（条码）", required=true, maxLength=100, fixed=0, order=9)
