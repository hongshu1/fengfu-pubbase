...
public abstract class BaseMoMaterialscanusedlogm<M extends BaseMoMaterialscanusedlogm<M>> extends JBoltBaseModel<M>{
    /**主键ID*/
	 ...
	 * 材料出库单号
	 */
	@JBoltField(name="cdocno" ,columnName="cDocNo",type="String", remark="材料出库单号", required=true, maxLength=40, fixed=0, order=6)
