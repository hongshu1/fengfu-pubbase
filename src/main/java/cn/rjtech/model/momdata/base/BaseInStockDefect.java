...
public abstract class BaseInStockDefect<M extends BaseInStockDefect<M>> extends JBoltBaseModel<M>{
    /**主键ID*/
	 ...
	 * 在库检ID
	 */
	@JBoltField(name="iinstockqcformmid" ,columnName="iInStockQcFormMid",type="Long", remark="在库检ID", required=true, maxLength=19, fixed=0, order=6)
