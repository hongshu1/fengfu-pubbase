...
public abstract class BaseSysProductindetail<M extends BaseSysProductindetail<M>> extends JBoltBaseModel<M>{
	 ...
	 * 产品编码
	 */
	@JBoltField(name="invcode" ,columnName="InvCode",type="String", remark="产品编码", required=false, maxLength=30, fixed=0, order=5)
