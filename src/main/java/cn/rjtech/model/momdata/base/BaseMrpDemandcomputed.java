...
public abstract class BaseMrpDemandcomputed<M extends BaseMrpDemandcomputed<M>> extends JBoltBaseModel<M>{
	 ...
	 * 是否锁定：0. 否 1. 是
	 */
	@JBoltField(name="islocked1" ,columnName="isLocked1",type="Boolean", remark="是否锁定：0. 否 1. 是", required=true, maxLength=1, fixed=0, order=9)
	 ...
	 * 是否锁定：0. 否 1. 是
	 */
	@JBoltField(name="islocked2" ,columnName="isLocked2",type="Boolean", remark="是否锁定：0. 否 1. 是", required=true, maxLength=1, fixed=0, order=10)
	 ...
	 * 是否锁定：0. 否 1. 是
	 */
	@JBoltField(name="islocked3" ,columnName="isLocked3",type="Boolean", remark="是否锁定：0. 否 1. 是", required=true, maxLength=1, fixed=0, order=11)
