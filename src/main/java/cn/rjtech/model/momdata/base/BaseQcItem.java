...
public abstract class BaseQcItem<M extends BaseQcItem<M>> extends JBoltBaseModel<M>{
    /**主键ID*/
    ...
    /**检验项目编码*/
    public static final String CQCITEMCODE = "cQcItemCode";
    /**检验项目名称*/
    public static final String CQCITEMNAME = "cQcItemName";
    /**创建人ID*/
	 ...
	 * 检验项目编码
	 */
	public M setCQcItemCode(java.lang.String cQcItemCode) {
		set("cQcItemCode", cQcItemCode);
		return (M)this;
	}
	 ...
	 * 检验项目编码
	 */
	@JBoltField(name="cqcitemcode" ,columnName="cQcItemCode",type="String", remark="检验项目编码", required=true, maxLength=40, fixed=0, order=5)
	@JSONField(name = "cqcitemcode")
	public java.lang.String getCQcItemCode() {
		return getStr("cQcItemCode");
	}

	/**
	 * 检验项目名称
	 */
	public M setCQcItemName(java.lang.String cQcItemName) {
		set("cQcItemName", cQcItemName);
		return (M)this;
	}
	 ...
	 * 检验项目名称
	 */
	@JBoltField(name="cqcitemname" ,columnName="cQcItemName",type="String", remark="检验项目名称", required=true, maxLength=50, fixed=0, order=6)
	@JSONField(name = "cqcitemname")
	public java.lang.String getCQcItemName() {
		return getStr("cQcItemName");
	}
	 ...
	 * 更新人名称
	 */
	@JBoltField(name="cupdatname" ,columnName="cUpdatName",type="String", remark="更新人名称", required=true, maxLength=50, fixed=0, order=11)
