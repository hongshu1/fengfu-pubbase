...
public abstract class BaseProdFormTableParam<M extends BaseProdFormTableParam<M>> extends JBoltBaseModel<M>{
	 ...
	 * 参数录入方式：1. CPK数值 2. 文本框 3. 选择（√，/，×，△，◎） 4. 单选 5. 复选 6. 下拉列表 7. 日期 8. 时间
	 */
	@JBoltField(name="itype" ,columnName="iType",type="Integer", remark="参数录入方式：1. CPK数值 2. 文本框 3. 选择（√，/，×，△，◎） 4. 单选 5. 复选 6. 下拉列表 7. 日期 8. 时间", required=true, maxLength=10, fixed=0, order=4)
	 ...
	 * 标准值
	 */
	@JBoltField(name="istdval" ,columnName="iStdVal",type="BigDecimal", remark="标准值", required=false, maxLength=24, fixed=6, order=5)
	 ...
	 * 最大设定值
	 */
	@JBoltField(name="imaxval" ,columnName="iMaxVal",type="BigDecimal", remark="最大设定值", required=false, maxLength=24, fixed=6, order=6)
	 ...
	 * 最小设定值
	 */
	@JBoltField(name="iminval" ,columnName="iMinVal",type="BigDecimal", remark="最小设定值", required=false, maxLength=24, fixed=6, order=7)
	 ...
	 * 列表可选值，多个";"分隔
	 */
	@JBoltField(name="coptions" ,columnName="cOptions",type="String", remark="列表可选值，多个;分隔", required=false, maxLength=500, fixed=0, order=8)
