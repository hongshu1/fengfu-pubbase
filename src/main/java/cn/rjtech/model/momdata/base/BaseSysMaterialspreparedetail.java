...
public abstract class BaseSysMaterialspreparedetail<M extends BaseSysMaterialspreparedetail<M>> extends JBoltBaseModel<M>{
    /**AutoID*/
	 ...
	 * 备料件数
	 */
	@JBoltField(name="num" ,columnName="Num",type="BigDecimal", remark="备料件数", required=false, maxLength=18, fixed=6, order=6)
	@JSONField(name = "num")
	 ...
	 * 备料数量
	 */
	@JBoltField(name="qty" ,columnName="Qty",type="BigDecimal", remark="备料数量", required=false, maxLength=18, fixed=6, order=7)
	@JSONField(name = "qty")
	 ...
	 * 包装比例
	 */
	@JBoltField(name="packrate" ,columnName="PackRate",type="BigDecimal", remark="包装比例", required=false, maxLength=18, fixed=6, order=8)
	 ...
	 * 来源单号+行号
	 */
	@JBoltField(name="sourcebillnorow" ,columnName="SourceBillNoRow",type="String", remark="来源单号+行号", required=false, maxLength=30, fixed=0, order=11)
	 ...
	 * 更新人
	 */
	@JBoltField(name="modifyperson" ,columnName="ModifyPerson",type="String", remark="更新人", required=false, maxLength=30, fixed=0, order=17)
