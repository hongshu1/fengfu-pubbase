...
public abstract class BaseSpotCheckForm<M extends BaseSpotCheckForm<M>> extends JBoltBaseModel<M>{
    /**主键ID*/
    ...
    /**检验表格名称*/
    public static final String CSPOTCHECKFORMNAME = "cSpotCheckFormName";
    /**创建人ID*/
	 ...
	 * 检验表格名称
	 */
	public M setCSpotCheckFormName(java.lang.String cSpotCheckFormName) {
	 ...
	 * 检验表格名称
	 */
	@JBoltField(name="cspotcheckformname" ,columnName="cSpotCheckFormName",type="String", remark="检验表格名称", required=true, maxLength=100, fixed=0, order=5)
	@JSONField(name = "cspotcheckformname")
	public java.lang.String getCSpotCheckFormName() {
		return getStr("cSpotCheckFormName");
	}
