...
public abstract class BaseBomMasterAudit<M extends BaseBomMasterAudit<M>> extends JBoltBaseModel<M>{
    /**主键ID*/
    ...
    /**启用时间*/
    public static final String DENABLETIME = "dEnableTime";
    /**停用时间*/
    public static final String DDISABLETIME = "dDisableTime";
	 ...
	 * 母件ID
	 */
	@JBoltField(name="ibommasterid" ,columnName="iBomMasterId",type="Long", remark="母件ID", required=true, maxLength=19, fixed=0, order=5)
	 ...
	 * 版本
	 */
	@JBoltField(name="cversion" ,columnName="cVersion",type="String", remark="版本", required=true, maxLength=10, fixed=0, order=7)
	 ...
	 * 启用时间
	 */
	public M setDEnableTime(java.util.Date dEnableTime) {
		set("dEnableTime", dEnableTime);
		return (M)this;
	}
	 ...
	 * 启用时间
	 */
	@JBoltField(name="denabletime" ,columnName="dEnableTime",type="Date", remark="启用时间", required=true, maxLength=10, fixed=0, order=8)
	@JSONField(name = "denabletime")
	public java.util.Date getDEnableTime() {
		return getDate("dEnableTime");
	}

	/**
	 * 停用时间
	 */
	public M setDDisableTime(java.util.Date dDisableTime) {
		set("dDisableTime", dDisableTime);
		return (M)this;
	}
	 ...
	 * 停用时间
	 */
	@JBoltField(name="ddisabletime" ,columnName="dDisableTime",type="Date", remark="停用时间", required=true, maxLength=10, fixed=0, order=9)
	@JSONField(name = "ddisabletime")
	public java.util.Date getDDisableTime() {
		return getDate("dDisableTime");
	}
	 ...
	 * 审核时间，未走审批流时，有值
	 */
	@JBoltField(name="daudittime" ,columnName="dAuditTime",type="Date", remark="审核时间，未走审批流时，有值", required=false, maxLength=23, fixed=3, order=11)
