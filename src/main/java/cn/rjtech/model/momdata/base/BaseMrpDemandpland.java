...
public abstract class BaseMrpDemandpland<M extends BaseMrpDemandpland<M>> extends JBoltBaseModel<M>{
    /**主键ID*/
	 ...
	 * 供应商ID
	 */
	@JBoltField(name="ivendorid" ,columnName="iVendorId",type="Long", remark="供应商ID", required=false, maxLength=19, fixed=0, order=6)
	 ...
	 * 存货ID
	 */
	@JBoltField(name="iinventoryid" ,columnName="iInventoryId",type="Long", remark="存货ID", required=false, maxLength=19, fixed=0, order=7)
	 ...
	 * 到货计划数
	 */
	@JBoltField(name="iqty" ,columnName="iQty",type="BigDecimal", remark="到货计划数", required=true, maxLength=24, fixed=6, order=8)
	@JSONField(name = "iqty")
	 ...
	 * 生成类型;0. 未生成 1. 采购订单 2. 销售订单
	 */
	@JBoltField(name="igentype" ,columnName="iGenType",type="Integer", remark="生成类型;0. 未生成 1. 采购订单 2. 销售订单", required=true, maxLength=10, fixed=0, order=10)
