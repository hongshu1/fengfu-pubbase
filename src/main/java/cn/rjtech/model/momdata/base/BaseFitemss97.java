...
public abstract class BaseFitemss97<M extends BaseFitemss97<M>> extends JBoltBaseModel<M>{
    /**主键ID*/
	 ...
	 * 项目编码
	 */
	@JBoltField(name="citemcode" ,columnName="citemcode",type="String", remark="项目编码", required=true, maxLength=60, fixed=0, order=5)
	 ...
	 * 项目名称
	 */
	@JBoltField(name="citemname" ,columnName="citemname",type="String", remark="项目名称", required=false, maxLength=255, fixed=0, order=6)
	 ...
	 * 是否封存
	 */
	public M setBclose(java.lang.Boolean bclose) {
		set("bclose", bclose);
		return (M)this;
	}
	 ...
	 * 是否封存
	 */
	@JBoltField(name="bclose" ,columnName="bclose",type="Boolean", remark="是否封存", required=false, maxLength=1, fixed=0, order=7)
	@JSONField(name = "bclose")
	public java.lang.Boolean getBclose() {
		return getBoolean("bclose");
	}
	 ...
	 * 项目大类编码
	 */
	@JBoltField(name="citemccode" ,columnName="citemccode",type="String", remark="项目大类编码", required=true, maxLength=22, fixed=0, order=8)
	 ...
	 * 其它系统是否使用
	 */
	@JBoltField(name="iotherused" ,columnName="iotherused",type="Integer", remark="其它系统是否使用", required=false, maxLength=10, fixed=0, order=9)
