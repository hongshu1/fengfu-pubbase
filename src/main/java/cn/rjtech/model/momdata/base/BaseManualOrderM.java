...
public abstract class BaseManualOrderM<M extends BaseManualOrderM<M>> extends JBoltBaseModel<M>{
	 ...
	 * 订单状态：1. 已保存 2. 待审批 3. 已审批 4. 审批不通过 5. 已发货 6. 已关闭
	 */
	@JBoltField(name="iorderstatus" ,columnName="iOrderStatus",type="Integer", remark="订单状态：1. 已保存 2. 待审批 3. 已审批 4. 审批不通过 5. 已发货 6. 已关闭", required=true, maxLength=10, fixed=0, order=9)
	 ...
	 * 审核状态：0. 未审批 1. 待审批 2. 审批通过 3. 审批不通过
	 */
	@JBoltField(name="iauditstatus" ,columnName="iAuditStatus",type="Integer", remark="审核状态：0. 未审批 1. 待审批 2. 审批通过 3. 审批不通过", required=true, maxLength=10, fixed=0, order=10)
	 ...
	 * 备注
	 */
	@JBoltField(name="cmemo" ,columnName="cMemo",type="String", remark="备注", required=false, maxLength=200, fixed=0, order=12)
