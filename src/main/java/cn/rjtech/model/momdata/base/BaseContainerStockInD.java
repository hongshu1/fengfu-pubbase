...
public abstract class BaseContainerStockInD<M extends BaseContainerStockInD<M>> extends JBoltBaseModel<M>{
    /**主键ID*/
    public static final String IAUTOID = "iAutoId";
    /**容器入库主表ID*/
    public static final String ICONTAINERSTOCKINMID = "iContainerStockInMid";
    /**容器ID*/
	 ...
	 * 容器入库主表ID
	 */
	public M setIContainerStockInMid(java.lang.Long iContainerStockInMid) {
		set("iContainerStockInMid", iContainerStockInMid);
		return (M)this;
	}
	 ...
	 * 容器入库主表ID
	 */
	@JBoltField(name="icontainerstockinmid" ,columnName="iContainerStockInMid",type="Long", remark="容器入库主表ID", required=true, maxLength=19, fixed=0, order=2)
	@JSONField(name = "icontainerstockinmid", serializeUsing = ToStringSerializer.class)
	public java.lang.Long getIContainerStockInMid() {
		return getLong("iContainerStockInMid");
	}
