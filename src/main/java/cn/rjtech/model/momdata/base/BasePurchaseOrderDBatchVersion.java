...
public abstract class BasePurchaseOrderDBatchVersion<M extends BasePurchaseOrderDBatchVersion<M>> extends JBoltBaseModel<M>{
    /**主键ID*/
    public static final String IAUTOID = "iAutoId";
    /**采购订单主表ID*/
    public static final String IPURCHASEORDERMID = "iPurchaseOrderMid";
    /**采购订单现票票记录ID*/
    public static final String IPURCHASEORDERDBATCHID = "iPurchaseOrderdBatchId";
    /**存货ID*/
	 ...
	 * 采购订单现票票记录ID
	 */
	public M setIPurchaseOrderdBatchId(java.lang.Long iPurchaseOrderdBatchId) {
		set("iPurchaseOrderdBatchId", iPurchaseOrderdBatchId);
		return (M)this;
	}
	 ...
	 * 采购订单现票票记录ID
	 */
	@JBoltField(name="ipurchaseorderdbatchid" ,columnName="iPurchaseOrderdBatchId",type="Long", remark="采购订单现票票记录ID", required=true, maxLength=19, fixed=0, order=3)
	@JSONField(name = "ipurchaseorderdbatchid", serializeUsing = ToStringSerializer.class)
	public java.lang.Long getIPurchaseOrderdBatchId() {
		return getLong("iPurchaseOrderdBatchId");
	}
