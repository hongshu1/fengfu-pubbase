package cn.rjtech.u9.entity.mis;
...
/**
 * 请购单行（MisLineDTO）
 * 料号	ItemInfo	String	Y	料品编码
 * 数量	StoreUOMQty	Decimal(18,9)	Y
 * 经手部门	HandleDept	Date		部门编码
 * 经手人	HandlePsn	String		人员必须在经手部门里
 * 受益部门	BenefitDept	String		部门编码
 * 受益人	BenefitPsn	String		人员必须在受益人里
 * VMI标志	IsVMI	Bool		默认false
 * 供应商	SupplierInfo	String		当IsVMI=true必填,供应商编码
 * 存储地点	WH	String	Y	存储地点编码
 * 客户	CustomerInfo	String		客户编码
 * 项目	Project	String		项目编码
 * 任务	Task	String		任务编码
 * 批号	LotInfo	Long		存储地点为批号管理必填 批号ID
 * 备注	Memo	String
 * 公共字段1到50	PubDescSeg1到PubDescSeg50	String
 * 私有字段字段1到30	PrivateDescSeg1到PrivateDescSeg30	String
 */
@XmlRootElement(name = "MisLineDTO")
@XmlAccessorType(value = XmlAccessType.FIELD)
public class MisLineDTO {

    @XmlElement(name = "ItemCode")
    @JSONField(name = "ItemCode")
    private String ItemCode;

    @XmlElement(name = "StoreUOMQty")
    @JSONField(name = "StoreUOMQty")
    private BigDecimal StoreUOMQty;

    @XmlElement(name = "HandleDept")
    @JSONField(name = "HandleDept")
    private String HandleDept;

    @XmlElement(name = "HandlePsn")
    @JSONField(name = "HandlePsn")
    ...
    @XmlElement(name = "BenefitPsn")
    @JSONField(name = "BenefitPsn")
    ...
    public BigDecimal getStoreUOMQty() {
        return StoreUOMQty;
    }

    public void setStoreUOMQty(BigDecimal storeUOMQty) {
        StoreUOMQty = storeUOMQty;
    }
    ...
    public Long getLotInfo() {
        return LotInfo;
    }

    public void setLotInfo(Long lotInfo) {
        LotInfo = lotInfo;
    }
