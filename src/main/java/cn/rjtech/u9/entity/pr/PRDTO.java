...
/**
 * 请购单头（PRDTO）
 * 单据类型	PRDocType	String	Y
 * 业务日期	BusinessDate	Date		默认当前日期
 * 备注	Memo	String
 * 请购行数据	PRLineDTOs	List<PRLineDTO>	Y
 * 公共字段1到段50	PubDescSeg1到PubDescSeg50	string
 * 私有字段字段1到段30	PrivateDescSeg1到PrivateDescSeg30	string
 */
@XmlRootElement(name = "PRDTO")
...
public class PRDTO {
    ...
    @XmlElement(name = "PRDocType")
    @JSONField(name = "PRDocType")
    ...
    @XmlElement(name = "PRLineDTO")
    @JSONField(name = "PRLineDTO")
    private List<PRLineDTO> prLineDTOS = new ArrayList<>();
    ...
    public String getPRDocType() {
        return PRDocType;
    }

    public void setPRDocType(String PRDocType) {
    ...
    public List<PRLineDTO> getPrLineDTOS() {
        return prLineDTOS;
    }

    public void setPrLineDTOS(List<PRLineDTO> prLineDTOS) {
        this.prLineDTOS = prLineDTOS;
    }
