package cn.rjtech.u9.entity.rpt;
...
/**
 * 成品入库行（RptLineDTO）
 * 生成订单	MO	String	Y	必须是开工的生产订单编码
 * 料品	Item	String		默认生产订单的料品
 * 存储地点	Wh	string	Y	存储地点编码
 * 项目	Project	String		项目编码
 * 受益部门	BenefitDept	String		部门编码
 * 入库数量	RcvQty	Decimal(18,9)	Y	必须大于0 单小于生产订单的生产数量
 * 成本入库数量	CostRcvQty	Decimal(18,9)	Y
 * 备注	Memo	String
 * 公共字段1到50	PubDescSeg1到PubDescSeg50	String
 * 私有字段字段1到30	PrivateDescSeg1到PrivateDescSeg30	String
 */
@XmlRootElement(name = "RptLineDTO")
@XmlAccessorType(value = XmlAccessType.FIELD)
public class RptLineDTO implements Serializable {
    ...
    @JSONField(name = "Item")
    private String item;
    @XmlElement(name = "ItemOrg")
    @JSONField(name = "ItemOrg")
    ...
    @XmlElement(name = "BenefitDept")
    @JSONField(name = "BenefitDept")
    private String benefitdept;
    @XmlElement(name = "RcvQty")
    @JSONField(name = "RcvQty")
    private BigDecimal rcvqty;
    @XmlElement(name = "CostRcvQty")
    @JSONField(name = "CostRcvQty")
    private BigDecimal costrcvqty;
    @XmlElement(name = "Memo")
    @JSONField(name = "Memo")
    private String memo;

    @XmlElement(name = "RcvCostQty")
    @JSONField(name = "RcvCostQty")
    private BigDecimal RcvCostQty;

    @XmlElement(name = "WhOrg")
    @JSONField(name = "WhOrg")
    private String whorg;
    @XmlElement(name = "OwnerOrg")
    @JSONField(name = "OwnerOrg")
    private String OwnerOrg;
    @XmlElement(name = "RcvOrg")
    @JSONField(name = "RcvOrg")
    ...
    public BigDecimal getRcvCostQty() {
        return RcvCostQty;
    }

    public void setRcvCostQty(BigDecimal rcvCostQty) {
        RcvCostQty = rcvCostQty;
    }
    ...
    public BigDecimal getCostrcvqty() {
        return costrcvqty;
    }

    public void setCostrcvqty(BigDecimal costrcvqty) {
        this.costrcvqty = costrcvqty;
    }
    ...
    public String toString() {
        return "RptLineDTO{" +
                ...
                ", wh='" + wh + '\'' +
                ", project='" + project + '\'' +
                ", benefitdept='" + benefitdept + '\'' +
                ", rcvqty='" + rcvqty + '\'' +
                ", costrcvqty='" + costrcvqty + '\'' +
                ", memo='" + memo + '\'' +
                '}';
    }
}
