 ...
 * 入库日期	ActualRcvTime	Date	Y	默认当前日期
 * 入库部门	RcvDep	String		部门编码
 * 入库人	RcvPerson			业务员编码 ，笔需是入库部门的业务员
 * 业务日期	DocDate	Date	Y	默认当前日期
 * 备注	Memo	String
 * 成品入库行数据	RptLineDTOs	List<IRCVLineDTO>	Y
 * 公共字段1到段50	PubDescSeg1到PubDescSeg50	string
 * 私有字段字段1到段30	PrivateDescSeg1到PrivateDescSeg30	string
 */
@XmlRootElement(name = "RptDTO")
@XmlAccessorType(value = XmlAccessType.FIELD)
public class RptDTO extends BaseReq implements Serializable {


    @XmlElement(name = "DocType")
    @JSONField(name = "DocType")
    private String doctype;
    @XmlElement(name = "ActualRcvTime")
    @JSONField(name = "ActualRcvTime")
    @XmlSchemaType(name = "dateTime")
    private String actualrcvtime;
    @XmlElement(name = "OrgCode")
    @JSONField(name = "OrgCode")
    private String orgcode;
    @XmlElement(name = "RcvDep")
    @JSONField(name = "RcvDep")
    private String rcvdep;
    @XmlElement(name = "RcvPerson")
    @JSONField(name = "RcvPerson")
    private String rcvperson;
    @XmlElement(name = "DocDate")
    @JSONField(name = "DocDate")
    @XmlSchemaType(name = "dateTime")
    ...
    @XmlElement(name = "rptLineDTOs")
    @JSONField(name = "rptLineDTOs")
    private List<RptLineDTO> rptlineDTOs = new ArrayList<>();
    ...
    @XmlElement(name = "PrivateDescSeg3")
    @JSONField(name = "PrivateDescSeg3")
    ...
    public List<RptLineDTO> getRptlineDTOs() {
        return rptlineDTOs;
    }

    public void setRptlineDTOs(List<RptLineDTO> rptlineDTOs) {
        this.rptlineDTOs = rptlineDTOs;
    }
    ...
    public String toString() {
        return "RptDTO{" +
                "doctype='" + doctype + '\'' +
                ", actualrcvtime='" + actualrcvtime + '\'' +
                ", orgcode='" + orgcode + '\'' +
                ", rcvdep='" + rcvdep + '\'' +
                ", rcvperson='" + rcvperson + '\'' +
                ", docdate='" + docdate + '\'' +
                ", memo='" + memo + '\'' +
                ", rptlineDTOs=" + rptlineDTOs +
                '}';
    }
