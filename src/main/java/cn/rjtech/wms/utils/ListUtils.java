            ...
            for (Object str : plugReturnData.keySet()) {
                switch (String.valueOf(str)) {
                    case "department":
                        ...
                        break;
                    case "vendor":
                        map.put("vendor", getJSONArray(plugReturnData, "vendor", "venCode"));
                        break;
                    case "customer":
                        map.put("customer", getJSONArray(plugReturnData, "customer", "cusCode"));
                        break;
                    case "warehouse":
                        map.put("warehouse", getJSONArray(plugReturnData, "warehouse", "WHCode"));
                        break;
                    case "inWarehouse":
                        map.put("inWarehouse", getJSONArray(plugReturnData, "inWarehouse", "WHCode"));
                        break;
                    case "outWarehouse":
                        map.put("outWarehouse", getJSONArray(plugReturnData, "outWarehouse", "WHCode"));
                        break;
                    case "inDepartment":
                        map.put("inDepartment", getJSONArray(plugReturnData, "inDepartment", "deptCode"));
                        break;
                    case "outDepartment":
                        map.put("outDepartment", getJSONArray(plugReturnData, "outDepartment", "deptCode"));
                        break;
                    case "RdType":
                        map.put("RdType", getJSONArray(plugReturnData, "RdType", "RdCode"));
                        break;
                    case "IRdType":
                        map.put("IRdType", getJSONArray(plugReturnData, "IRdType", "RdCode"));
                        break;
                    case "ORdType":
                        map.put("ORdType",getJSONArray(plugReturnData, "ORdType", "ORdCode"));
                        break;
                    case "person":
                        map.put("person",getJSONArray(plugReturnData, "person", "personCode"));
                        break;
                    case "memo":
                        map.put("memo", plugReturnData.get("memo"));
                        break;
                    case "notIn":
                        map.put("notIn", plugReturnData.get("notIn"));
                        break;
                    case "not":
                        map.put("not", plugReturnData.get("not"));
                        break;
                    case "notIN1":
                        map.put("notIN1", plugReturnData.get("notIN1"));
                        break;
                    case "inventory":
                        map.put("inventory",getJSONArray(plugReturnData, "inventory", "inventoryCode"));
                        break;
                    case "vt_id":
