...
public class Md5Utils {
    ...
    private static final Log LOG = Log.getLog(Md5Utils.class);
    ...
    /**
     * 获取文件的MD5值，20221012 潘家宝
     */
    public static String getFileMD5(String filename) {
        try {
            return DigestUtils.md5Hex(Files.newInputStream(Paths.get(filename)));
        } catch (IOException e) {
