	...
	public static void main(String[] args) {
        ...
        JBoltColumnToBuildAttrNameFunction columnTobuildAttrNameFun = column -> {
            ...
            if(column.contains("_")) {
                return StrKit.toCamelCase(column.toLowerCase()).toLowerCase();
            }
            return StrKit.toCamelCase(column, true);
        };
		...
		new WmsModelGenerator().generate(configName,dataDictionaryVersion,dataDictionaryDescription);
	}
}
