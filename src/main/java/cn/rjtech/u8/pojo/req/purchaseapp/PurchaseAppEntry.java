...
public class PurchaseAppEntry {
    ...
    @XmlElement(name = "originaltaxedprice")
    private String originaltaxedprice;
    ...
    @XmlElement(name = "deptcodeexec")
    private String deptcodeexec;

    @XmlElement(name = "personcodeexec")
    private String personcodeexec;
    ...
    public void setOriginaltaxedprice(String originaltaxedprice) {
        this.originaltaxedprice = originaltaxedprice;
    }
    ...
    public void setPersoncodeexec(String personcodeexec) {
        this.personcodeexec = personcodeexec;
    }
    ...
    public void setOriginalsum(String originalsum) {
    ...
    public String toString() {
        return "PurchaseAppEntry{" +
                ...
                ", originaltaxedprice='" + originaltaxedprice + '\'' +
                ", item_code='" + itemCode + '\'' +
                ", sum='" + sum + '\'' +
                ", deptcodeexec='" + deptcodeexec + '\'' +
                ", personcodeexec='" + personcodeexec + '\'' +
