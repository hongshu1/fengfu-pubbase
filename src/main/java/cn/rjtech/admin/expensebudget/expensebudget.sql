                  ...
                  FROM
                      (
                          ...
                          FROM
                              ...
                              LEFT JOIN #(getMomdataDbName()).dbo.bas_subjectm bsh ON bsh.csubjectcode = ebi.cHighestSubjectCode
                              LEFT JOIN #(getMomdataDbName()).dbo.bas_subjectm bsl ON bsl.csubjectcode = ebi.cLowestSubjectCode
                          WHERE
                              1 = 1
