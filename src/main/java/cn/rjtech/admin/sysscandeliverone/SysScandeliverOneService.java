 ...
 */
public class SysScandeliverOneService extends BaseService<SysScandeliver> {
	...
	public List<Record> rcvpland(Kv kv) {
		return dbTemplate("sysscandeliverone.rcvpland", kv).find();
	}

	public List<Record> customeraddr(Kv kv) {
		return dbTemplate("sysscandeliverone.customeraddr", kv).find();
	}
