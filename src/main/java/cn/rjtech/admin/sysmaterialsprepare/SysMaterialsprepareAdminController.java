...
//	}
	...
	*/
	...
	public void manual() {
		...
		SysMaterialspreparedetail sysMaterialspreparedetail = serviceD.findFirst("select *   from T_Sys_MaterialsPrepareDetail where MasID=?", sysMaterialsprepare.getAutoID());
		Inventory inventory = invent.findFirst("select *   from Bd_Inventory where cInvCode=?", sysMaterialspreparedetail.getInvCode());
