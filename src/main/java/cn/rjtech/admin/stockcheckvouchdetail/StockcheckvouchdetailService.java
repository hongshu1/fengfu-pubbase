...
public class StockcheckvouchdetailService extends BaseService<Stockcheckvouchdetail> {
     ...
     * 保存参数
     * */
    public void saveDetailModel(Stockcheckvouchdetail stockcheckvouchdetail, StockCheckVouch stockCheckVouch) {
        stockcheckvouchdetail.setAutoID(String.valueOf(JBoltSnowflakeKit.me.nextId()));
        stockcheckvouchdetail.setMasID(String.valueOf(stockCheckVouch.getAutoid()));
        stockcheckvouchdetail.setSourceID("");
        stockcheckvouchdetail.setPosCode("");
        stockcheckvouchdetail.setInvCode("");
        stockcheckvouchdetail.setQty(new BigDecimal(0));
        stockcheckvouchdetail.setNum(new BigDecimal(0));
        stockcheckvouchdetail.setCreatePerson(JBoltUserKit.getUserName());
        stockcheckvouchdetail.setCreateDate(new Date());
    }
