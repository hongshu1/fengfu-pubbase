...
SELECT
    (CASE
         WHEN iPid1 IS NULL THEN iPid2
         ELSE iPid1
        END) IPid
     ,* FROM (
                 SELECT
                     (SELECT TOP 1 b.iAutoId FROM Bd_fitemss03class b WHERE  a.cItemCcode LIKE CONCAT('', b.cItemCcode, '%') AND b.iAutoId != a.iAutoId  ORDER BY b.cItemCcode ASC) iPid1,
...
SELECT
    (SELECT TOP 1 b.iAutoId FROM Bd_fitemssZFclass b WHERE  a.cItemCcode LIKE CONCAT('', b.cItemCcode, '%') AND b.iAutoId != a.iAutoId  ORDER BY b.cItemCcode ASC) iPid1,
...
SELECT
    (SELECT TOP 1 b.iAutoId FROM Bd_fitemss00class b WHERE  a.cItemCcode LIKE CONCAT('', b.cItemCcode, '%') AND b.iAutoId != a.iAutoId  ORDER BY b.cItemCcode ASC) iPid1,
...
SELECT
    (SELECT TOP 1 b.iAutoId FROM Bd_fitemss98class b WHERE  a.cItemCcode LIKE CONCAT('', b.cItemCcode, '%') AND b.iAutoId != a.iAutoId  ORDER BY b.cItemCcode ASC) iPid1,
