                ...
                try {
                    while (true) {
                        ...
                        if(StrUtil.isBlank(processBusMapData.get("pcloseperson")) && StrUtil.isBlank(processBusMapData.get("bcloseperson"))) {
                            ...
                            // ---------------------------------------------------------
                            try {
                                txInErp(saveExchangeTables, erpDbAlias, erpDBName, vouchType, vouchBusinessID, orgApp, processBusMapData, dataConversion, userApp, prevProcessBus, type, plugeReturnMap, result, mainData, detailData, extData, SourceJson, now);
