...
public class FormUpload  implements Serializable  {
    ...
    /** 从表数据  */
    private List<FormUploadd> formUploadds=new ArrayList<>();
    ...
    public String getcFormSn(){
        return cFormSn;
    }
    public void setcFormSn(String cFormSn){
        this.cFormSn=cFormSn;
    }
    ...
    public List<FormUploadd> getFormUploadds(){
        return formUploadds;
    }
