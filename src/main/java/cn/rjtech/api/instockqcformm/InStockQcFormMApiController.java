...
public class InStockQcFormMApiController extends BaseApiController {
    ...
    public void saveCheckOut(@Para(value = "cmeasurepurpose") String cmeasurepurpose,
        ...
        renderJBoltApiRet(apiService.saveCheckOut(cmeasurepurpose, cdcno, iinstockqcformmid, cmeasureunit, isok, cmeasurereason, serializeSubmitList, cmemo));
    }
    ...
    public void saveEdit(@Para(value = "cmeasurepurpose") String cmeasurepurpose,
        ...
        renderJBoltApiRet(apiService.saveEdit(cmeasurepurpose, cdcno, iinstockqcformmid, cmeasureunit, isok, cmeasurereason, serializeSubmitList, cmemo));
    }
    ...
    public void findDetailByBarcode(@Para(value = "cbarcode") String cbarcode) {
        ValidationUtils.notBlank(cbarcode, "现品票不存在！！！");
     ...
     * @param cinvcode1      客户部番
     * @param cinvname1      部品名称
     * @param iinventoryid   bd_inventory表的主键
     * @param cdcno          设变号
     * @param cmeasurereason 测定理由
     * @param iqcformid      bd_qcform表的主键
     */
    @ApiDoc(result = NullDataResult.class)
    @UnCheck
