...
(function () {
     ...
     */
	window.UEDITOR_HOME_URL = "/assets/plugins/neditor/";
    ...
    window.UEDITOR_CONFIG = {
        ...
        scrawlUrlPrefix: "",
        videoFieldName:"file",
        videoMaxSize:20971520,// video上传大小限制，单位B
        videoUrlPrefix: "",
        fileUrlPrefix: "",
        ...
        whitList: {
            ...
            hr: [],
            i: ['class', 'style'],
            img: ['word_img','anchorname','style', 'src', 'alt', 'title', 'width', 'height', 'id', '_src', '_url', 'loadingclass', 'class', 'data-latex'],
            ins: ['datetime'],
            li: ['class', 'style'],
            mark: [],
            nav: [],
