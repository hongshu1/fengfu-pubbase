...
(function ($) {
  ...
  Selectpicker.prototype = {
    ...
    setMenuSize: function (isAuto) {
      ...
      var jbolt_layer = this.$menu.closest(".jbolt_layer");
      if(jbolt_layer&&jbolt_layer.length>0){
    	  $(".dropdown.bootstrap-select.show-tick>.dropdown-menu.show").removeClass("show");
    	  this.$menu.addClass("show"); 
    	  var that =this;
    	  if(!this.$menu.data("initClickedEvent")){
    		  this.$menu.data("initClickedEvent",true);
    		  jbolt_layer.on("click",function(e){
    			  var ele=$(e.target).closest(".bootstrap-select");
    			  if(!ele||ele.length==0){
    				  that.$menu.removeClass("show");
    			  }
    		  });
    	  }
      }
