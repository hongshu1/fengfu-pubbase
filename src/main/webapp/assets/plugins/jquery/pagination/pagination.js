...
;(function($){
	...
	$.fn.pagination = function(maxentries, opts){
		...
		opts = $.extend({
			...
			prev_text:"<i></i> <section class='d-sm-inline d-none'>上一页</section>",
			next_text:"<section class='d-sm-inline d-none'>下一页 </section> <i></i>",
			ellipse_text:"...",
		...
		function paginationClickHandler(evt){
			...
			var links, 
				new_current_page = target.data('page_id'),
