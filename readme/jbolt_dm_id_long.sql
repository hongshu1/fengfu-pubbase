...
(
    ...
    "of_moudle" INT DEFAULT 1,
    "of_moudle_link" VARCHAR(40),
    NOT CLUSTER PRIMARY KEY("id")) STORAGE(ON "MAIN", CLUSTERBTR) ;
...
COMMENT ON COLUMN "JBOLT"."jb_permission"."of_moudle" IS '哪个模块';
COMMENT ON COLUMN "JBOLT"."jb_permission"."of_moudle_link" IS '具体指向关联';
...
COMMENT ON COLUMN "JBOLT"."jb_user"."of_moudle" IS '哪个模块';
COMMENT ON COLUMN "JBOLT"."jb_user"."of_moudle_link" IS '具体指向关联';
