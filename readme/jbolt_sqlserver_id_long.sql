...
CREATE TABLE [dbo].[jb_code_gen] (
    ...
    [main_table_pkey] nvarchar(64) COLLATE Chinese_PRC_CI_AS  NULL,
    ...
    [leftbox_width] int  NULL,
    [rightbox_width] int  NULL,
    [headbox_height] int  NULL,
    [footbox_height] int  NULL,
    ...
    [table_width] nvarchar(40) COLLATE Chinese_PRC_CI_AS  NOT NULL,
    [table_height_assign] nvarchar(40) COLLATE Chinese_PRC_CI_AS  NULL,
    [table_height] nvarchar(40) COLLATE Chinese_PRC_CI_AS  NOT NULL,
