...
CREATE TABLE `jb_user`  (
  ...
  `sn` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '工号',
...
CREATE TABLE `jb_wechat_media`  (
  ...
  `digest` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '描述',
...
`translate_type` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '翻译类型',
